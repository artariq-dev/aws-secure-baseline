...
resource "aws_iam_role" "github_actions_non_prod" {
  name = "github-actions-non-prod"
...
resource "aws_iam_role_policy_attachment" "github_actions_non_prod" {
  role       = aws_iam_role.github_actions_non_prod.name
